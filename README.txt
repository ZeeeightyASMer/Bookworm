...
This software, the game, is freeware. This game is free for commercial use with the condition that the game is not altered. This game is only to be put on a single physical cartridge (i.e. not a multi-game cartridge).
